...
steps:
  ...
  calcium-channel-blockers-trandolapril---primary:
    run: calcium-channel-blockers-trandolapril---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  calcium-channel-blockers-adalat---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: calcium-channel-blockers-trandolapril---primary/output
  ...
  calcium-channel-blockers-focus---primary:
    run: calcium-channel-blockers-focus---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  calcium-channel-blockers-liquid---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: calcium-channel-blockers-focus---primary/output
  ...
  calcium-channel-blockers-winthrop---primary:
    run: calcium-channel-blockers-winthrop---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: calcium-channel-blockers-winthrop---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
