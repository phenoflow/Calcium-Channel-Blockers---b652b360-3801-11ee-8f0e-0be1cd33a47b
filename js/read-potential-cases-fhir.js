...
(async () => {
  ...
  await fs.writeFile("calcium-channel-blockers-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("calcium-channel-blockers-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
